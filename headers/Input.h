...
enum INPUT_STATE { INPUT_STATE_UP, INPUT_STATE_JUST_BECAME_UP,
	INPUT_STATE_JUST_BECAME_DOWN, INPUT_STATE_DOWN };
...
private:
	...
	static inline std::unordered_map<int, INPUT_STATE> mouse_button_states; //Left: 1. Middle: 2. Right: 3.
